...
def scrape_data(param):
  ...
  for i in range(0, len(rows)):
    ...
    data_scrape.append(
      (product_name, price, product_rating, product_seller, product_location)
    )
...
if __name__ == '__main__':
  ...
  df = pd.DataFrame(all_data, columns = ['Nama Produk', 'Harga Produk', 'Rating', 'Penjual', 'Lokasi'])
  df.to_excel('ListRyzen5600g.xlsx', index = False)
